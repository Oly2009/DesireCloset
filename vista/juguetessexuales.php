...
$query = "SELECT p.*, u.nombreUsuario, u.foto as fotoUsuario, f.nombreFoto, t.estado,
          ...
          WHERE p.idCategoria = (SELECT idCategoria FROM Categorias WHERE nombreCategoria = 'Juguetes sexuales')
...
<div class="ver container mt-5">
    <div style="background-color: black; color: white; padding: 10px; margin-bottom: 20px;">
        <h2 class="mb-4" style="text-transform: uppercase; font-weight: bold; text-align: center;">Juguetes Sexuales</h2>
    </div>
    <div class="row">
